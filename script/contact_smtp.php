<?php
/*
Template Name: MoonCart Shop & eCommerce HTML Template
...
$dzEmailTo 		= "info@exemple.com.com";   /* Receiver Email Address */
$dzEmailFrom    = "MoonCart Contact";
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Contact')
		{
			...
			$dzMailSubject = 'MoonCart|Contact Form: A Person want to contact';
			$dzMailMessage	= 	"
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			$dzMailSubject = 'MoonCart|Appointment Form: A Person want to contact';
			$dzMailMessage	= 	"
								A person want to contact you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>".$dzPhoneMessage."
